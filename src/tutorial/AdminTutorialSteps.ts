...
export const adminTutorialSteps: TutorialStep[] = [
  ...
  },
  {
    id: 17,
    route: "/app/clients",
    text: "Completa el nombre del cliente en este bloque.",
  ...
  },
  {
    id: 18,
    route: "/app/clients",
    text: "Completa el teléfono del cliente en este bloque.",
    highlightSelector: "#clients-form-phone",
    placement: "bottom",
  },
  {
    id: 19,
  ...
  },
  {
    id: 22,
    route: "/app/clients",
    text: "Cuando estés listo, abre 'Reservas' en el menú lateral.",
  ...
  },
  {
    id: 24,
    route: "/app/bookings",
    text: "Aquí podras seleccionar el cliente que ya habiamos creado o crear uno nuevo",
